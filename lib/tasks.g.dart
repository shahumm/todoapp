...
extension TasksQueryFilter on QueryBuilder<Tasks, Tasks, QFilterCondition> {
  ...
  QueryBuilder<Tasks, Tasks, QAfterFilterCondition> isCompletedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TasksQueryLinks on QueryBuilder<Tasks, Tasks, QFilterCondition> {
  QueryBuilder<Tasks, Tasks, QAfterFilterCondition> user(FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'user');
    });
  }

  QueryBuilder<Tasks, Tasks, QAfterFilterCondition> userIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension TasksQuerySortBy on QueryBuilder<Tasks, Tasks, QSortBy> {
  ...
  QueryBuilder<Tasks, Tasks, QAfterSortBy> sortByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Tasks, Tasks, QAfterSortBy> sortByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TasksQuerySortThenBy on QueryBuilder<Tasks, Tasks, QSortThenBy> {
  ...
  QueryBuilder<Tasks, Tasks, QAfterSortBy> thenByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Tasks, Tasks, QAfterSortBy> thenByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.desc);
    });
  }
...
extension TasksQueryWhereDistinct on QueryBuilder<Tasks, Tasks, QDistinct> {
  ...
  QueryBuilder<Tasks, Tasks, QDistinct> distinctByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
...
extension TasksQueryProperty on QueryBuilder<Tasks, Tasks, QQueryProperty> {
  ...
  QueryBuilder<Tasks, bool, QQueryOperations> isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
